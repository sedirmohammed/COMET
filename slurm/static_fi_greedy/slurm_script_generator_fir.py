...
#SBATCH --output=dg_%a_{dataset_name}_{abbreviation}.out
#SBATCH --error=dg_%a_{dataset_name}_{abbreviation}.err
#SBATCH --array=1-4
...
"""
    ...
    with open(f"{ROOT_DIR}/slurm/static_fi_greedy/static_fi_greedy_{dataset_name}_{abbreviation}.slurm", "w") as out_file:
