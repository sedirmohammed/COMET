...
#SBATCH --output=cr_%a_{dataset_name}_{abbreviation}.out
#SBATCH --error=cr_%a_{dataset_name}_{abbreviation}.err
#SBATCH --array=1-4
...
"""
    ...
    with open(f"{ROOT_DIR}/slurm/completely_random/completely_random_{dataset_name}_{abbreviation}.slurm", "w") as out_file:
