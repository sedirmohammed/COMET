...
def main(ml_algorithm, error_type, ds_name: str, original_budget, metadata, database_engine, pre_pollution_setting_ids) -> None:
    ...
    table_name = f'cleaning_results_{ds_name}_{ml_algorithm.__name__}_{error_type.__name__}'
    ...
    for pollution_setting in pre_pollution_settings:
        ...
        #pollution_setting = {'pre_pollution_setting_id': pre_pollution_setting_id, 'train': {'Number of children': 0.05, 'Wife\'s age': 0.01}, 'test': {'Number of children': 0.05, 'Wife\'s age': 0.01}}
        ...
        while BUDGET >= 0:
            ...
            if cleaning_result.get_feature() is not None:
                ...
                write_feature_prediction_results_to_db(cleaning_configs, experiment_results, database_engine, iteration,
                                                       ds_name, ml_algorithm.__name__, error_type.__name__,
