...
def main(ml_algorithm, error_type, ds_name: str, original_budget, metadata, database_engine, pre_pollution_setting_ids) -> None:
    ...
    table_name = f'comet_light_cleaning_results_{ds_name}_{ml_algorithm.__name__}_{error_type.__name__}'
    ...
    for pollution_setting in pre_pollution_settings:
        print(f'Start COMET light for {ds_name}, {ml_algorithm.__name__}, {error_type.__name__}, pre-pollution setting {pollution_setting["pre_pollution_setting_id"]}')
        ...
        sorted_features, predicted_f1_scores = recommender.get_sorted_features_to_clean(cleaning_configs=cleaning_configs,
        ...
        print(f'Start with comet light (CL) cleaning process for {ds_name}, {ml_algorithm.__name__}, {error_type.__name__}, pre-pollution setting {pre_pollution_setting_id}')
        while BUDGET >= 0:
            ...
            cleaning_result: CleaningResult = recommender.recommend_and_clean(cleaning_configs=cleaning_configs,
                                                                              ...
                                                                              predicted_f1_scores_et=predicted_f1_scores)
