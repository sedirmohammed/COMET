...
st.title('COMET evaluation considering the multi-error scenario AC')
...
dynamic_greedy_cleaning_schedule = load_and_filter_data(
    'cleaning_results', ds_name, error_type, '', DATABASE_URL)

activeclean_results = load_and_filter_data(
    'activeclean_results', ds_name, error_type, '', DATABASE_URL)

cleaned_data = load_and_filter_data(
    'cleaned_data_results', ds_name, error_type, '', DATABASE_URL)
